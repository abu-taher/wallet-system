...
/**
 * REST API endpoint for deducting balance from user accounts
 * POST /api/account/charge
 * 
 * This is a simplified REST wrapper around the tRPC charge procedure
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Charge REST API error:', error);
